...
* Add browser management settings (`markdown-pdf.browser.name`, `.version`, `.channel`, `.cacheDir`) for deterministic exports across machines
* Switch to the `@puppeteer/browsers` downloader to keep pace with modern Chromium builds
